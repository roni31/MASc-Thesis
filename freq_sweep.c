...
unsigned long START_FREQ = 10000;	 // in Hertz (unsigned long has 32 bits, from which we will only need 24)
unsigned long INCREMENT_FREQ = 1500; // in Hertz
unsigned short NPOINTS = AD5933_MAX_INC_NUM;
double gainFactor = 0;
...
int main(void)
{
	...
	printf("\n\n");
	printf("/******************************************************************************\n");
	printf("*                           Frequecy Sweep App                                *\n");
	printf("*-----------------------------------------------------------------------------*\n");
	printf("****************************@authors: Ronish Patel**************************  *\n");
	printf("*                               MASc Thesis                                   *\n");
	printf("*                                                                             *\n");
	printf("* @creation: Jan /2019                                                        *\n");
	printf("*                                                                             *\n");
	printf("------------------------------------------------------------------------------\n");
...

	{
		...
		fprintf(fout, "%f\t%lu\n", Z_MOD[freq_iter], CurrentFrequency);

		fprintf(gnuplot, "%lu %f\n", CurrentFrequency, Z_MOD[freq_iter]);
